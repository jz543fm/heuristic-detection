...
var prediction2 = predict2(testdata);

chrome.runtime.sendMessage(prediction2);
/**
...
chrome.runtime.onMessage.addListener(
    function(prediction2, sender, sendResponse){
    ...
    if (prediction2 == 1){
      ...
      * @function
      * @param {var} prediction2
      */
        chrome.runtime.onMessage.removeListener(prediction2);
        console.log("Removed\n");
    }
